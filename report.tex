...
{\footnotesize Shareable proof link:\\
\href{https://tiancheng2016-cell.github.io/JordanChevalleyFormalization/}{https://tiancheng2016-cell.github.io/JordanChevalleyFormalization/}\\[6pt]
Source repository:\\
\href{https://github.com/tiancheng2016-cell/JordanChevalleyFormalization}{https://github.com/tiancheng2016-cell/JordanChevalleyFormalization}\par}
\end{center}
...
There is no sorryAx. The proof is not choice-free, since \texttt{Classical.choice} appears in the printed axiom dependencies. This dependence is expected for the present Jordan--Chevalley formalization: the theorem is stated over an algebraically closed field and finite-dimensional vector spaces, and the proof uses Mathlib tools for eigenvalue existence, generalized eigenspace decompositions, semisimplicity, and finite-dimensional decompositions, which typically rely on nonconstructive classical reasoning. Therefore, this Lean proof retains these standard classical dependencies as part of the final formalization, rather than presenting the result as a fully choice-free development.
